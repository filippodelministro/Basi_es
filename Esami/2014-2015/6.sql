Esercizio 1 (7 punti)
Scrivere una query che restituisca la dose giornaliera media dei farmaci indicati per la cura di sole patolo-
gie intestinali.
Esercizio 2 (7 punti)
Scrivere una query che restituisca, per il sesso maschile e per quello femminile, rispettivamente, il numero
di pazienti attualmente affetti da ipertensione, trattata con lo stesso farmaco da più di venti anni.
Esercizio 3 (8 punti)
Scrivere una query che, considerate le sole patologie muscolari, elimini gli esordi conclusi con guarigione
relativi a pazienti che hanno contratto, e curato con successo, almeno due di tali patologie.
